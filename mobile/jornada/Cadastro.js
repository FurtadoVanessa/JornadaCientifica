...
import { SafeAreaView, Text, View, Button, TextInput, ScrollView, Picker } from 'react-native';
  ...
  return (
    <SafeAreaView style={{ flex: 1, marginTop: Constants.statusBarHeight }}>
      ...
      <ScrollView style={{ marginHorizontal: 30 }}>
        <View style={{ alignSelf: 'flex-start', width: 95, height: 35, marginTop: 15 }}>
          <Button title="Voltar" color="#2F9E41" />
        </View>

        <View style={{ width: 300, height: 75 }}>
          <Text style={{ textAlign: 'center' }}>Nome</Text>
          <TextInput style={{ height: 40, borderColor: 'black', borderWidth: 1, textAlign: 'center' }} />
        </View>
        ...
        <View style={{ width: 300, height: 75 }}>
          ...
          <TextInput style={{ height: 40, borderColor: 'black', borderWidth: 1, textAlign: 'center' }} secureTextEntry={true} />
        </View>
